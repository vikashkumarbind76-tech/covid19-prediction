...
def init_db():
    ...
    # Force sqlite_sequence creation
    cursor.execute("CREATE TABLE IF NOT EXISTS _dummy_seq (id INTEGER PRIMARY KEY AUTOINCREMENT)")
    cursor.execute("INSERT INTO _dummy_seq DEFAULT VALUES")
    cursor.execute("DELETE FROM _dummy_seq")
...
def admin_login():
    ...
    if request.method == 'POST':
        ...
        if ADMIN_USERNAME and ADMIN_PASSWORD and username.lower() == ADMIN_USERNAME.lower() and password == ADMIN_PASSWORD:
